...
const MusicSection = ({ songs, setSongs, room_code, setModalAction }: Props) => {
    ...
    return (
        <>
            <div className="flex flex-col items-center w-full gap-2">
                ...
                <ReactPlayer url="https://www.youtube.com/watch?v=ysz5S6PUM-U" width={"320px"} height={"180px"} style={{ borderRadius: "20px" }} />
