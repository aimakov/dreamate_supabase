          ...
          <div className="flex flex-col items-center w-11/12 max-w-md bg-white py-6 px-10 rounded-xl">
            ...
            <div className=" text-sm text-[#334155] flex flex-col gap-6">
              <p>
                ...
                Policy outlines the types of personal information we collect,
              ...
              <div className="flex flex-col gap-2">
                ...
                <ul className="list-disc pl-6">
                  ...
                  <li>
                    Information about your device and internet connection, such
              ...
              <div className="flex flex-col gap-2">
                ...
                <p>
                  ...
                  required by law. We take reasonable measures to protect the
              ...
              <div className="flex flex-col gap-2">
                ...
                <p>
                  ...
                  information, as well as to request that we delete it or
                  restrict its use. You may also object to the processing of
                  your personal information and request that we provide your
                  information in a portable format. To exercise these rights,
              ...
              <div className="flex flex-col gap-2">
                ...
                <p>
                  ...
                  the last update. We encourage you to review this Privacy
                  Policy periodically.
                </p>
              </div>
